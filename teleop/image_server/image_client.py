...
class ImageClient:
    def __init__(self, tv_img_shape = None, tv_img_shm_name = None, wrist_img_shape = None, wrist_img_shm_name = None, 
                       image_show = False, server_address = "192.168.123.163", port = 5555, Unit_Test = False):
        """
...
if __name__ == "__main__":
    ...
    client = ImageClient(image_show = True, server_address='192.168.123.163', Unit_Test=False) # deployment test
